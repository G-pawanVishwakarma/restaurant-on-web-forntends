...
const discount = '/assets/images/payment-method/discount.png';
            ...
            <Grid container spacing={3} alignItems="center">
              ...
              <Grid item xs={12} sm={8}>
                <Stack spacing={0.25}>
                  ...
                  <Typography variant="caption">When you subscribe to the unlimited consultation plan on Restaurants on web material.</Typography>
                </Stack>
              </Grid>
