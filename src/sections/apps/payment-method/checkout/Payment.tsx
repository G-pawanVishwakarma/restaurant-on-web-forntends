...
const cvv = '/assets/images/payment-method/cvv.png';
const lock = '/assets/images/payment-method/lock.png';
const master = '/assets/images/payment-method/master-card.png';
const paypalcard = '/assets/images/payment-method/paypal.png';

// TYPES
import { CartCheckoutStateProps } from 'types/cart';
import { Address, PaymentOptionsProps } from 'types/payment-method';
...
const Payment = ({ checkout, onBack, onNext, handleShippingCharge, removepayment, editAddress }: PaymentProps) => {
