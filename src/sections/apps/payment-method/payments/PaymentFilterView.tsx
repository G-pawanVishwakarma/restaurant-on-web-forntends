...
interface paymentFilterViewProps {
  filter: PaymentsFilter;
  initialState: PaymentsFilter;
  filterIsEqual: (initialState: PaymentsFilter, filter: PaymentsFilter) => boolean;
  handelFilter: (type: string, params: string, rating?: number) => void;
}

const PaymentFilterView = ({ filter, filterIsEqual, handelFilter, initialState }: paymentFilterViewProps) => {
